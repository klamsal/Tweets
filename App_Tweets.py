...
select = st.sidebar.selectbox('Visualization type', ['Bar plot', 'Pie chart'], key="1_fix1")
...
if not st.sidebar.checkbox("Close", True, key="1_fix2"):
...
each_airline = st.sidebar.selectbox('Visualization type', ['Bar plot', 'Pie chart'], key="2_fix1")
...
if not st.sidebar.checkbox("Close", True, key="2_fix2"):
...
if len(choice) > 0:
    ...
    breakdown_type = st.sidebar.selectbox('Visualization type', ['Pie chart', 'Bar plot', ], key="3_fix1")
...
if not st.sidebar.checkbox("Close", True, key="3_fix2"):
